...
import dev.Alejandro.lakeSideHotel.repository.BookedRoomRepository;
...
public class BookedRoomServiceImpl implements IBookedRoomService {
    ...
    public String saveBooking(Long roomId, BookedRoom bookingRequest) {
        if (bookingRequest.getCheckOutDate().isBefore(bookingRequest.getCheckInDate())){
            throw new InvalidBookingResponseException("check-in data must come before check-out date");
        }
        ...
        if (roomIsAvailable){
            ...
            throw new InvalidBookingResponseException("This room has already been booked for the selected date");
