...
import dev.Alejandro.lakeSideHotel.exception.PhotoRetrievalException;
...
import dev.Alejandro.lakeSideHotel.service.BookedRoomServiceImpl;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> updateRoom(@PathVariable Long roomId,
        ...
        Blob photoBlob = photoBytes != null && photoBytes.length > 0 ? new SerialBlob(photoBytes)
                : null;
        ...
        */
        ...
        if (photoBlob!=null){
            try{
                ...
                throw new PhotoRetrievalException("Error Retrieving");
            }
        }
